...
class PoseNet(nn.Module):
    ...
    def pred_func(self, data, repeat_num, save_path='./visualization_results', return_average_res=False, init_x=None,
        ...
        with torch.no_grad():
            ...
            ''' Inference '''
            in_process_sample, res = self.net(repeated_data, mode=f'{self.cfg.sampler_mode[0]}_sample',
                                              init_x=repeated_init_x, T0=T0)
