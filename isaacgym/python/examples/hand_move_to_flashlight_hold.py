...
hand_pose.p = gymapi.Vec3(0.95, 1.2, 0.25)  # 设置手的位置
...
#     prop.contact_offset = 0.02  # 设置接触偏移量
#     prop.rest_offset = 0.00000001  # 设置静止偏移量
#
# 设置手电筒刚体属性
...
intermediate_point_x=0.94585304
intermediate_point_y=1.05999996
intermediate_point_z=0.28200001
intermediate_point=(intermediate_point_x,intermediate_point_y,intermediate_point_z)
intermediate_point1_x=0.93585304
intermediate_point1_y=1.11999996
intermediate_point1_z=0.28200001
...
while not gym.query_viewer_has_closed(viewer):
    ...
    if np.allclose(current_position1, np.array([0.95584136,1.04031992,0.28193602]), atol=wucha):
