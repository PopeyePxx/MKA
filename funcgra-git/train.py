...
parser.add_argument('--model_file', type=str, default='/home/yf/funcgra/save_models/best/best_aff_model_21_5.035_0.313_0.865.pth')
...
shutil.copy('./models/keypoint.py', args.save_path)
...
if __name__ == '__main__':
    ...
    from data.datatrain_16 import TrainData
    ...
    from data.datatest_viz import TestData
    ...
    for epoch in range(args.epochs):
        ...
        if not os.path.exists(GT_path):
            process_gt(args)
        GT_masks = torch.load('/home/yf/funcgra/Seen_gt.t7')
