...
import models.transform_utils as T
import yaml
...
@njit(cache=True, fastmath=True)
def get_samples_jitted(control_points_homo, control_points_quat, opt_interpolate_pos_step_size,
...
def get_callable_grasping_cost_fn(env):
    def get_grasping_cost(keypoint_idx):
        ...
        return -env.is_grasping(
            candidate_obj=keypoint_object) + 1  # return 0 if grasping an object, 1 if not grasping any object
